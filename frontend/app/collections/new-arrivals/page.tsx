  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const response = await fetch(`${API_BASE_URL}/api/Product?includeDrafts=false&categoryName=New Arrivals`)
        if (response.ok) {
      ...
      <div className="max-w-7xl mx-auto px-8 py-16">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
          <div className="flex items-center gap-4">
            ...
            <span className="text-gray-600 font-gill-sans">{products.length} new products</span>
          </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-600 font-gill-sans">No new products found.</p>
          </div>
        ) : (
          <div
